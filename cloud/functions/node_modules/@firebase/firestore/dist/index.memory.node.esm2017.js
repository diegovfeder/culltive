...
class AsyncQueue {
    constructor() {
        ...
        this.visibilityHandler = () => {
            ...
            this.runDelayedOperationsEarly("async_queue_retry" /* AsyncQueueRetry */);
        };
        ...
        this.retryableTail = this.retryableTail.then(() => {
            ...
            const retryingOp = async () => {
                try {
                    ...
                    if (isIndexedDbTransactionError(e)) {
                        logDebug(LOG_TAG$2, 'Operation failed with retryable error: ' + e);
 ...
 * limitations under the License.
 */
const LOG_TAG$4 = 'PersistentStream';
...
const LOG_TAG$6 = 'WatchChangeAggregator';
/**
 ...
 * limitations under the License.
 */
const LOG_TAG$9 = 'FirestoreClient';
...
class ParseContext {
     ...
     * compromised).
     */
    constructor(settings, databaseId, serializer, fieldTransforms, fieldMask) {
...
class UserDataReader {
    constructor(databaseId, serializer) {
        this.databaseId = databaseId;
        this.serializer =
...
function registerFirestore(instance) {
    configureForFirebase(instance, (app, auth) => new Firestore(app, auth, new MemoryComponentProvider()));
