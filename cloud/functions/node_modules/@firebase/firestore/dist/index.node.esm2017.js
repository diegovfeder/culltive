...
class IndexedDbPersistence {
    ...
    start() {
        ...
        return SimpleDb.openOrCreate(this.dbName, SCHEMA_VERSION, new SchemaConverter(this.serializer))
            ...
            return this.simpleDb.runTransaction('readonly', [DbTargetGlobal.store], txn => getHighestListenSequenceNumber(txn));
        })
    ...
    ensureSequenceNumbers(txn) {
        ...
        return getHighestListenSequenceNumber(txn).next(currentSequenceNumber => {
            const writeSentinelKey = (path) => {
                return documentTargetStore.put(new DbTargetDocument(0, encodeResourcePath(path), currentSequenceNumber));
            };
            const promises = [];
            return documentsStore
                .iterate((key, doc) => {
