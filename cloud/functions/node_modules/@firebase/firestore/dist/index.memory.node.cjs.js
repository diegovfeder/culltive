                ...
                switch (_c.label) {
                    ...
                    case 2:
                        ...
                        if (isIndexedDbTransactionError(e_1)) {
                            ...
                            logDebug(LOG_TAG, 'Failed to update sequence numbers: ' + e_1);
                        }
                        else {
                            throw e_1;
                        }
                    ...
                    switch (_c.label) {
                        ...
                        case 2:
                            ...
                            if (isIndexedDbTransactionError(e_2)) {
                                logDebug(LOG_TAG$2, 'Operation failed with retryable error: ' + e_2);
                                this.backoff.backoffAndRun(retryingOp);
                            }
                            else {
                                deferred.resolve();
                                throw e_2; // Failure will be handled by AsyncQueue
                            }
                            return [3 /*break*/, 3];
...
var SyncEngine = /** @class */ (function () {
        ...
        return tslib.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib.__generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 5:
                        e_3 = _c.sent();
                        error = wrapInUserErrorIfRecoverable(e_3, "Failed to persist write");
    ...
    SyncEngine.prototype.registerPendingWritesCallback = function (callback) {
        return tslib.__awaiter(this, void 0, void 0, function () {
            var highestBatchId, callbacks, e_4, firestoreError;
            return tslib.__generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                    ...
                    case 3:
                        e_4 = _c.sent();
                        firestoreError = wrapInUserErrorIfRecoverable(e_4, 'Initialization of waitForPendingWrites() operation failed');
 ...
 * limitations under the License.
 */
var LOG_TAG$4 = 'PersistentStream';
...
var PersistentStream = /** @class */ (function () {
    ...
    PersistentStream.prototype.handleStreamClose = function (error) {
        ...
        logDebug(LOG_TAG$4, "close with error: " + error);
        this.stream = null;
        ...
        return function (fn) {
            _this.queue.enqueueAndForget(function () {
                if (_this.closeCount === startCloseCount) {
                    ...
                    logDebug(LOG_TAG$4, 'stream callback skipped by getCloseGuardedDispatcher.');
                    return Promise.resolve();
                }
            });
        };
 ...
 * limitations under the License.
 */
var LOG_TAG$5 = 'OnlineStateTracker';
...
var LOG_TAG$6 = 'WatchChangeAggregator';
/**
...
var WatchChangeAggregator = /** @class */ (function () {
    ...
    WatchChangeAggregator.prototype.isActiveTarget = function (targetId) {
        ...
        if (!targetActive) {
            logDebug(LOG_TAG$6, 'Detected inactive target', targetId);
        }
        return targetActive;
    };
    /**
...
var RemoteStore = /** @class */ (function () {
    ...
    RemoteStore.prototype.onWatchStreamChange = function (watchChange, snapshotVersion) {
        return tslib.__awaiter(this, void 0, void 0, function () {
            var e_5, lastRemoteSnapshotVersion, e_6;
            return tslib.__generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                    ...
                    case 3:
                        e_5 = _c.sent();
                        logDebug(LOG_TAG$7, 'Failed to remove targets %s: %s ', watchChange.targetIds.join(','), e_5);
                        return [4 /*yield*/, this.disableNetworkUntilRecovery(e_5)];
                    case 4:
                        _c.sent();
                        return [3 /*break*/, 5];
                    case 5: return [2 /*return*/];
                    ...
                    case 11:
                        e_6 = _c.sent();
                        logDebug(LOG_TAG$7, 'Failed to raise snapshot:', e_6);
        ...
        return tslib.__awaiter(this, void 0, void 0, function () {
            return tslib.__generator(this, function (_c) {
                ...
                if (isPermanentError(error.code)) {
                    logDebug(LOG_TAG$7, 'RemoteStore error before completed handshake; resetting stream token: ', this.writeStream.lastStreamToken);
            ...
            return tslib.__generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        logDebug(LOG_TAG$7, 'RemoteStore restarting streams for new credential');
                        return [4 /*yield*/, this.restartNetwork()];
                    case 1:
                        _c.sent();
                        _c.label = 2;
...
var EventManager = /** @class */ (function () {
    ...
    EventManager.prototype.listen = function (listener) {
        return tslib.__awaiter(this, void 0, void 0, function () {
            var query, firstListen, queryInfo, _c, e_7, firestoreError, raisedEvent, raisedEvent_1;
            return tslib.__generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                    ...
                    case 3:
                        e_7 = _d.sent();
                        firestoreError = wrapInUserErrorIfRecoverable(e_7, "Initialization of query '" + listener.query + "' failed");
                ...
                switch (_c.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.asyncQueue.enqueue(function () { return tslib.__awaiter(_this, void 0, void 0, function () {
                                var maybeDoc, e_8, firestoreError;
                                return tslib.__generator(this, function (_c) {
                                    switch (_c.label) {
                                        case 0:
                                            _c.trys.push([0, 2, , 3]);
                                        ...
                                        case 2:
                                            e_8 = _c.sent();
                                            firestoreError = wrapInUserErrorIfRecoverable(e_8, "Failed to get document '" + docKey + " from cache");
            ...
            return tslib.__generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        deferred = new Deferred();
                        return [4 /*yield*/, this.asyncQueue.enqueue(function () { return tslib.__awaiter(_this, void 0, void 0, function () {
                                var queryResult, view, viewDocChanges, viewChange, e_9, firestoreError;
                                return tslib.__generator(this, function (_c) {
                                    switch (_c.label) {
                                        case 0:
                                            _c.trys.push([0, 2, , 3]);
                                        ...
                                        case 2:
                                            e_9 = _c.sent();
                                            firestoreError = wrapInUserErrorIfRecoverable(e_9, "Failed to execute query '" + query + " against cache");
                                            deferred.reject(firestoreError);
                                            return [3 /*break*/, 3];
                                        case 3: return [2 /*return*/];
                                    }
...
var GrpcConnection = /** @class */ (function () {
    ...
    GrpcConnection.prototype.ensureActiveStub = function () {
        if (!this.cachedStub) {
            logDebug(LOG_TAG$a, 'Creating Firestore stub.');
    ...
    GrpcConnection.prototype.invokeRPC = function (rpcName, request, token) {
        ...
        return nodePromise(function (callback) {
            logDebug(LOG_TAG$a, "RPC '" + rpcName + "' invoked with request:", request);
            return stub[rpcName](request, metadata, function (grpcError, value) {
                if (grpcError) {
                    logDebug(LOG_TAG$a, "RPC '" + rpcName + "' failed with error:", grpcError);
                    callback(new FirestoreError(mapCodeFromRpcCode(grpcError.code), grpcError.message));
                }
                else {
                    logDebug(LOG_TAG$a, "RPC '" + rpcName + "' completed with response:", value);
    ...
    GrpcConnection.prototype.invokeStreamingRPC = function (rpcName, request, token) {
        ...
        logDebug(LOG_TAG$a, "RPC '" + rpcName + "' invoked (streaming) with request:", request);
        var stub = this.ensureActiveStub();
        var metadata = createMetadata(this.databaseInfo, token);
        var stream = stub[rpcName](request, metadata);
        stream.on('data', function (response) {
            logDebug(LOG_TAG$a, "RPC " + rpcName + " received result:", response);
            results.push(response);
        });
        stream.on('end', function () {
            logDebug(LOG_TAG$a, "RPC '" + rpcName + "' completed.");
    ...
    GrpcConnection.prototype.openStream = function (rpcName, token) {
        ...
        var stream = new StreamBridge({
            sendFn: function (msg) {
                if (!closed) {
                    logDebug(LOG_TAG$a, 'GRPC stream sending:', msg);
                    try {
                    ...
                    logDebug(LOG_TAG$a, 'Not sending because gRPC stream is closed:', msg);
                }
            },
            closeFn: function () {
                logDebug(LOG_TAG$a, 'GRPC stream closed locally via close().');
                close();
            }
        });
        grpcStream.on('data', function (msg) {
            if (!closed) {
                logDebug(LOG_TAG$a, 'GRPC stream received:', msg);
                stream.callOnMessage(msg);
            }
        });
        grpcStream.on('end', function () {
            logDebug(LOG_TAG$a, 'GRPC stream ended.');
            close();
        });
        grpcStream.on('error', function (grpcError) {
            logDebug(LOG_TAG$a, 'GRPC stream error. Code:', grpcError.code, 'Message:', grpcError.message);
            var code = mapCodeFromRpcCode(grpcError.code);
            close(new FirestoreError(code, grpcError.message));
        });
        logDebug(LOG_TAG$a, 'Opening GRPC stream');
