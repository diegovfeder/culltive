...
function listHandler(authWrapper, bucket) {
    function handler(xhr, text) {
        const listResult = fromResponseString(authWrapper, bucket, text);
...
function list(authWrapper, location, delimiter, pageToken, maxResults) {
    ...
    const method = 'GET';
    const timeout = authWrapper.maxOperationRetryTime();
    const requestInfo = new RequestInfo(url, method, listHandler(authWrapper, location.bucket), timeout);
